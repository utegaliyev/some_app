...
using some_app.Application.TodoItems.Commands.UpdateTodoItem;
using some_app.Application.TodoItems.Commands.UpdateTodoItemDetail;
using some_app.Application.TodoItems.Queries.GetTodoItemsWithPagination;
